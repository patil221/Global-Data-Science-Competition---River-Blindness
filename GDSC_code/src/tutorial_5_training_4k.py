...
def load_config(data_folder):
    ...
    #base_file = "/mmdetection/configs/resnest/cascade_rcnn_s101_fpn_syncbn-backbone+head_mstrain-range_1x_coco.py"
    #base_file='/mmdetection/configs/mask_rcnn/mask_rcnn_r101_caffe_fpn_mstrain-poly_3x_coco.py'
...
if __name__ == "__main__":
    ...
    epoch = 'epoch_10'  # Select one of the model checkpoints to load in (changed from 8 to 10)   
